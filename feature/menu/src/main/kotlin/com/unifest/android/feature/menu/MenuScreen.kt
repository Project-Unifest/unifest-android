    ...
    Box {
        Column {
            UnifestTopAppBar(
                ...
                title = "메뉴",
                elevation = 8.dp,
                modifier = Modifier.background(Color.White, shape = RoundedCornerShape(bottomEnd = 20.dp, bottomStart = 20.dp)),
            )
            LazyColumn {
                ...
                item {
                    Row(
                        ...
                        Text(text = "나의 관심학교", style = Title3)
                        Text(text = "추가하기>", style = Content7, color = Color(0xFF545454))
                    }
                }
                item {
                    LazyVerticalGrid(
                            ...
                            .height(
                                when {
                                    uiState.festivals.isEmpty() -> 0.dp
                                        ...
                                        val rows = ((uiState.festivals.size - 1) / 4 + 1) * 130
                                        rows.dp
                                    }
                                },
                            ),
                        ...
                        items(uiState.festivals.size) { index ->
                            val school = uiState.festivals[index]
                            SchoolItem(
                                festival = school,
                            )
                        }
                ...
                item {
                    Row(
                        ...
                        Text(text = "더보기>", style = Content7, color = Color(0xFF545454))
                    }
                }
                ...
                itemsIndexed(uiState.interestedBooths) { index, booth ->
                    Column {
                        ...
                        IncomingFestivalCard(booth)
                    }
                    if (index < uiState.interestedBooths.size - 1) {
                        Spacer(modifier = Modifier.height(16.dp))
                        HorizontalDivider(
...
fun MenuItem(icon: ImageVector, title: String, onClick: () -> Unit) {
    Row(
        ...
        Icon(icon, contentDescription = null, tint = Color(0xFF7A7A7C))
...
@Composable
fun IncomingFestivalCard(booth: BoothDetailEntity) {
    ...
    Row(
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(13.dp))//todo:23dp 너무 멀음
            Row {
                Icon(
